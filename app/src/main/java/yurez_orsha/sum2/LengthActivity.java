...
public class LengthActivity extends AppCompatActivity {
    ...
    int l1;
    int l2;
    private String[] mass={"meter","centimeter","millimeter","kilometer", "decimeter","mile", "yard","foot","inch","nautical mile"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyAsyncTask myat=new MyAsyncTask(String.valueOf(l1),String.valueOf(l2),editText.getText().toString(),"2");
                myat.execute();
